            ...
            <React.Fragment>
                ...
                >
                    <ul className="content_menu relative mb-auto">
                        ...
                        {this.getLi(false, "Trang chủ", (
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="36" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                        ...
                        ), [["Đăng ký", "dang_ky_de_tai"],["Của bạn", "de_tai_cua_ban"]])}

                    </ul>
                    <ul className="content_menu relative pb-4" onClick={()=> this.setState( (prev) => ({...prev, main : "profile"}))}>
                ...
                <main id="main_content" className="main_content">
                    <div className="content" id="main_trang_chu">
                        ...
                        {main == "profile" && <Profile ma_sinh_vien={this.props.ma_sinh_vien}/>}
                        {main == "dang_ky_de_tai" && <Dang_Ky_De_Tai ma_sinh_vien={this.props.ma_sinh_vien}/>}
                        {main == "de_tai_cua_ban" && <DeTaiCuaBan ma_sinh_vien={this.props.ma_sinh_vien}/>}
